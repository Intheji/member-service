...
Spring Boot 기반 **팀원 소개 서비스**를 AWS 인프라 위에 구축한 프로젝트입니다.

단일 서버 구조가 아닌 **Stateless 아키텍처**를 기반으로,  
DB / 파일 저장소 / 서버를 분리하고  
Docker, CI/CD, Auto Scaling, HTTPS, CDN까지 적용한 **클라우드 네이티브 서비스**입니다.
...
- 만료 시간: 2026년 3월 18일 4시 34분에 Presigned URL 만료예정
- 스크린샷이 없어졌습니다......
...
아쉬운 건 과제하는 것에 급급하여 트러블 슈팅을 제대로 작성 못한 것이 아쉽습니다.
그래도 도전까지 해낸 제 자신이 자랑스럽고 꼭 이 과정이 익숙해지도록 더 열심히 노력하고 싶습니다.
